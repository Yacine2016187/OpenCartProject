...
import com.qa.opencard.utils.ExcelUtil;

public class RegistrationPageTest extends BaseTest {

	@BeforeClass
	public void setupRegistration() {
		registernew = loginpage.goToRegisterPage();
	}
	...
	public void userRegistrationTest(String firstName, String lastName, String telphone, 
		...
		Assert.assertTrue(
				registernew.accountRegistration(firstName, lastName, getRandomEmail(), telphone, password, subscribe));
